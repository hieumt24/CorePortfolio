...
namespace CorePortfolio.Infrastructure.Migrations
{
    ...
    [Migration("20260729060903_AddAnalyticsDecisionReviewScope")]
    partial class AddAnalyticsDecisionReviewScope
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.AnalyticsDecision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("InsightCodes")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");

                    b.Property<bool>("IsPortfolioScope")
                        .HasColumnType("INTEGER");

                    b.Property<decimal?>("MaximumDrawdownPercentage")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal?>("MoneyWeightedReturnPercentage")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("PortfolioNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(160)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("RiskTriggers")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("ScopeFrom")
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("ScopeTo")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal?>("TimeWeightedReturnPercentage")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal>("TrackedPortfolioValue")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.AuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.CashLedgerEntry", b =>
                {
                    ...
                    b.HasIndex("CashAccountId", "Classification", "OccurredAt");
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.PortfolioSnapshot", b =>
                {
                    ...
                    b.Property<decimal>("NetExternalFlow")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("StaleAssetCount")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("UnclassifiedCashFlowCount")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.SessionRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("SessionRefreshTokens");
                });
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.TwoFactorChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.TwoFactorRecoveryCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CorePortfolio.Domain.Entities.SessionRefreshToken", b =>
                {
                    b.HasOne("CorePortfolio.Domain.Entities.UserSession", "UserSession")
