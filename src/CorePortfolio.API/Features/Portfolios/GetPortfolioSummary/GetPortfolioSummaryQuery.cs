...
public record AssetSummaryDto(Guid AssetId, string Symbol, string Name, AssetType Type, decimal CurrentPrice, decimal TotalQuantity, decimal TotalCost, decimal CurrentValue);
